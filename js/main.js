...
const add_id = "uujplkrntqvt1fkn"; // app_id
const app_secret = "R0MzeUV4WDF1R0RDejBqbWM0b0Q0UT09"; // app_secret
const key = "657a2cae88394dc4866c861685419060" // key
function getWeather() {
...
$('#switchmore').on('click', function () {
    ...
    if (shoemore && $(document).width() >= 990) {
        ...
        $("#change").html("Hello&nbsp;hahaha&nbsp;!");
        $("#change1").html("本人很懒，没留下什么…… ");
    }
});
